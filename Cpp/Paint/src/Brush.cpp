...
sf::CircleShape Brush::getCircle() {
    ...
    circle.setOrigin(this->brushSize/2, this->brushSize/2);
...
sf::CircleShape Brush::getTriangle() {
    ...
    triangle.setOrigin(this->brushSize/2, this->brushSize/2);
...
sf::CircleShape Brush::getSquare() {
    ...
    square.setOrigin(this->brushSize/2, this->brushSize/2);
...
sf::CircleShape Brush::getOctagon() {
    ...
    octagon.setOrigin(this->brushSize/2, this->brushSize/2);
